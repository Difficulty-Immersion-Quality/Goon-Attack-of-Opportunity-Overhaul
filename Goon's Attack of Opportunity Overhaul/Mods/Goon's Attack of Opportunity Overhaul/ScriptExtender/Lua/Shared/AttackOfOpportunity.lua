...
local PatchTargets = {
	...
	Goon_Interrupt_AttackOfOpportunity = {
		Fields = {
			...
			Conditions = {
				on = "Goon_AttackOfOpportunityConditions(nil,false,false,nil,nil)",
				off = "Goon_AttackOfOpportunityConditions(false,false,false,nil,nil)",
			},
		},
	},
	...
	Interrupt_WarCaster = {
		Fields = {
			...
			Conditions = {
				on = "Goon_AttackOfOpportunityConditions(nil,false,false,nil,nil) and not HasSpellCastBlocked(context.Observer)",
				off = "Goon_AttackOfOpportunityConditions(false,false,false,nil,nil) and not HasSpellCastBlocked(context.Observer)",
			},
		},
	},
	...
	Goon_Interrupt_AttackOfOpportunity_Mainhand = {
		Fields = {
			...
			Conditions = {
				on = "Goon_AttackOfOpportunityConditions(nil,false,false,false,false)",
				off = "Goon_AttackOfOpportunityConditions(false,false,false,false,false)",
			},
		},
	},
	...
	Goon_Interrupt_AttackOfOpportunity_Offhand = {
		Fields = {
			...
			Conditions = {
				on = "Goon_AttackOfOpportunityConditions(nil,false,false,false,true)",
				off = "Goon_AttackOfOpportunityConditions(false,false,false,false,true)",
			},
		},
	},
	...
	Goon_Interrupt_AttackOfOpportunity_RangedMainhand = {
		Fields = {
			...
			Conditions = {
				on = "Goon_AttackOfOpportunityConditions(nil,false,false,true,false)",
				off = "Goon_AttackOfOpportunityConditions(false,false,false,true,false)",
			},
		},
	},
	...
	Goon_Interrupt_AttackOfOpportunity_RangedOffhand = {
		Fields = {
			...
			Conditions = {
				on = "Goon_AttackOfOpportunityConditions(nil,false,false,true,true)",
				off = "Goon_AttackOfOpportunityConditions(false,false,false,true,true)",
			},
		},
	},
	...
	Goon_Interrupt_AttackOfOpportunity_Shove = {
		Fields = {
			...
			Conditions = {
				on = "Goon_AttackOfOpportunityConditions(nil,false,false,nil,nil) and (not Self() and CanShoveWeight() and IsMovable() and not Grounded() and not Tagged('GASEOUS_FORM') and not (not Player(context.Source) and Combat(context.Source) and Character() and not (Enemy() or HasStatus('SG_Unconscious'))) and not Tagged('CANT_SHOVE_THROW'))",
				off = "Goon_AttackOfOpportunityConditions(false,false,false,nil,nil) and (not Self() and CanShoveWeight() and IsMovable() and not Grounded() and not Tagged('GASEOUS_FORM') and not (not Player(context.Source) and Combat(context.Source) and Character() and not (Enemy() or HasStatus('SG_Unconscious'))) and not Tagged('CANT_SHOVE_THROW'))",
			},
		},
	},
	...
	Goon_Interrupt_AttackOfOpportunity_Grapple = {
		Fields = {
			...
			Conditions = {
				on = "Goon_AttackOfOpportunityConditions(nil,false,false,nil,nil) and (not Self() and CanGrappleTargetSize() and IsMovable() and not Grounded() and not Tagged('GASEOUS_FORM') and not HasStatus('SG_Unconscious') and not Tagged('CANT_SHOVE_THROW'))",
				off = "Goon_AttackOfOpportunityConditions(false,false,false,nil,nil) and (not Self() and CanGrappleTargetSize() and IsMovable() and not Grounded() and not Tagged('GASEOUS_FORM') and not HasStatus('SG_Unconscious') and not Tagged('CANT_SHOVE_THROW'))",
			},
		},
	},
}
